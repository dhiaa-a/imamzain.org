...
export default function Footer() {
	return (
		<div className="flex flex-col items-center justify-around gap-10 p-6 mx-auto bg-slate-50 border-t-[1px] border-green-700 border-opacity-40">
			...
			<div className="flex flex-wrap gap-8 items-center justify-center text-sm text-slate-500">
				<Link href="#">الصفحة الرئيسية</Link>
				<Link href="#">الامام زين العابدين(ع)</Link>
				<Link href="#">انشطتنا</Link>
				<Link href="#">اصداراتنا</Link>
